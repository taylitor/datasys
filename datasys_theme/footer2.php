       <!-- footer -->
        <div class="col-xs-12 Pad0" style="background: #07081e;background: url(<?php echo get_template_directory_uri() ?>/assets/img/bg-grd-2.png) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
            <div data-depth="0.6" class="layer">
                <div id="particles-js-footer"></div>
            </div>
            <div class="col-xs-12 text-center mTop50 Pad0" style="z-index: 1;">
                        ...
                        <p class="text-left text-white istok let-sp-0 mTop10" style="font-size: 16px;line-height: 1.736;">
                            <a href="<?php echo the_field('reclutamiento_link') ?>" class="link-red text-center text-white istok-b let-sp-0 mTop10" style="text-decoration: none;">
                                <?php echo the_field('reclutamiento') ?>
                                                ...
                                                <p class="text-left text-white istok let-sp-0 mTop10" style="font-size: 16px;line-height: 1.736;">
                            <a href="<?php echo ot_get_option('link_carbono'); ?>" class="link-red text-center text-white istok-b let-sp-0 mTop10" style="text-decoration: none; display: inline-block;" download>
                                <img src="<?php echo ot_get_option('imagen_carbono'); ?>" alt="" style="max-width: 100%;">
                            </a>
                        </p>
...
?>
        ...
        <!--<script src="<?php echo get_template_directory_uri() ?>/assets/plugins/particles/js/main_particles.js"></script>-->
        ...
        <script src="<?php echo get_template_directory_uri() ?>/assets/plugins/search/js/classie.js"></script>
        <script src="<?php echo get_template_directory_uri() ?>/assets/plugins/search/js/uisearch.js"></script>
        <script>
            new UISearch(document.getElementById('sb-search'), document.getElementById('sb-search-parent'));
        </script>
        <script type="text/javascript">
            function autocollapse() {
                ...
                if (navbar_cont.innerHeight() > 100 || navbar_cont.innerWidth() < 1024) {
                    console.log(navbar_cont.innerHeight());
            ...
            function initialize_owl_services(owl) {
                owl.owlCarousel({
                    ...
                    autoplayTimeout: 5000,
                    navText: [
                        '<img src="<?php echo get_template_directory_uri() ?>/assets/img/back.svg" alt="" style="height: 70px;">',
                        '<img src="<?php echo get_template_directory_uri() ?>/assets/img/next.svg" alt="" style="height: 70px;">',
                    ]
                });
            }
